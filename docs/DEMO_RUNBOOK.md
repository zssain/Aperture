...
| **`make demo-flip` doesn't flip** | Kabir is only flippable once per reset. If already flipped, show his *already-superseded* pair (DECLINE→APPROVE) on his case, or point at pre-flipped Vikram Rao in Newly eligible. |
